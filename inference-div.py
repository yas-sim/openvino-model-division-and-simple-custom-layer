...
def main():
	...
	for label, img in zip(test_labels, test_images):
		...
		img /= 255.0
		# Cascade 2 models
		result1 = exec_net1.infer(inputs={input_name1: img})					# 1st half of the original model
		result2 = exec_net2.infer(inputs={input_name2: result1[output_name1]})	# 2nd half of the original model
